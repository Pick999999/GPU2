        ...
        const result = await $.ajax({
            ...
            success: function (response, textStatus, jqXHR) {
                ...
                if (response.NumRec === 0) {
                    ...
                    document.getElementById("CodeCandleMaster").value = '';
                } else {
                    const jsonData = JSON.stringify(response.DataResult, null, 2);
                    document.getElementById("CodeCandleMaster").value = jsonData;
					...
					ColorCodeMaster = response.DataResult ;
					return ColorCodeMaster ;
                }
            },
